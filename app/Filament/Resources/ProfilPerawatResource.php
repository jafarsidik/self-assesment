    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                ...
                ->schema([
                    TextInput::make('namalengkap')->label('Nama Lengkap'),
                    Select::make('jeniskelamin')->label('Jenis Kelamin')->options([
                        'Laki-Laki' => 'Laki-Laki',
                        'Perempuan' => 'Perempuan'
                    ]),
                    Textarea::make('alamat_ktp')->label('Alamat Domisili (Sesuai KTP)'),
                    Textarea::make('alamat_tinggal')->label('Alamat Tinggal'),
