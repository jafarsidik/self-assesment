                    ...
                    ->schema([
                        ...
                        Repeater::make('sub_kompetensi_dan_kode')->label('Sub Kompetensi & Kode')->required()
                            ->schema([
                                ...
                                Checkbox::make('is_d')->label('Ini adalah Berinisial D?'),
                                TextInput::make('detail_sub_kompetensi'),
                                Select::make('tingkat_kemapuan_vokasi')->label('Tingkat Kemampuan Vokasi')->required()
                                    ->options([
                                        '4' => '4',
                                        '3' => '3',                                
                                        '2' => '2',                                
                                ...
                                Select::make('tingkat_kemapuan_ners')->label('Tingkat Kemampuan Ners')->required()
                                    ->options([
                                        '4' => '4',
                                        '3' => '3',                                
                                        '2' => '2',                                
